...
// O cookie pode sobreviver ao JWT curto para que o interceptor receba 401 e
// faça refresh; a API continua rejeitando o token após 1 hora.
const ACCESS_TOKEN_MAX_AGE = 30 * 24 * 60 * 60;
