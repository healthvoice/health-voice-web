...
/**
 * A tela de cadastro em si. Separada da `page.tsx` porque a página virou Server
 * Component para decidir, antes de renderizar, se o cadastro existe neste
 * ambiente — ver o comentário lá.
 */
